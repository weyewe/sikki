...
describe GroupLoan do
  ...
  it 'should have group_loan_subcriptions' do
    GroupLoanSubcription.all.count.should == Member.all.count 
  end
  it 'should have equal duration' do
    @group_loan.all_group_loan_memberships_have_equal_duration?.should be_true  
  end
