class SavingsAccountWithdrawal < ActiveRecord::Base
  belongs_to :member 
  ...
  validate :no_more_than_one_unconfirmed_savings_account_withdrawal
  ...
  def create_savings_entries
    SavingsEntry.create_savings_account_withdrawal( self,  self.amount )
  end
